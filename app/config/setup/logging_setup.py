...
def initialize_root_logger(console_handle_params: ConsoleHandleParams | StructuredConsoleHandleParams):
...
def create_console_handler(
    handler_params: ConsoleHandleParams | StructuredConsoleHandleParams,
